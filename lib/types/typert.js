...
/** Schemas contributed under this package, keyed `<package>#<name>`. */
const SCHEMAS = [
    { name: 'SidechatContextArgs', schema: contextArgsSchema },
    { name: 'SidechatProjectContext', schema: projectContextSchema },
    { name: 'SidechatModelsResult', schema: modelsResultSchema },
    { name: 'SidechatStartArgs', schema: startArgsSchema },
    { name: 'SidechatJobIdResult', schema: jobIdResultSchema },
    { name: 'SidechatPollArgs', schema: pollArgsSchema },
    { name: 'SidechatPollResult', schema: pollResultSchema },
    { name: 'SidechatStopArgs', schema: stopArgsSchema },
    { name: 'SidechatStopResult', schema: stopResultSchema },
];
/**
...
export const TYPERT = {
    ...
    face: 'host',
    schemas: SCHEMAS,
    // The generator would reflect service/event/object metadata here; a
    // self-contained package contributes none, and the registry stores the model
    ...
    invocations: [
        {
            ...
            parameters: [{
                    ...
                    wire: 'args',
                    source: 'json',
                    codec: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatContextArgs', schema: contextArgsSchema },
                }],
            result: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatProjectContext', schema: projectContextSchema },
        },
        {
            ...
            invocation: { kind: 'direct' },
            parameters: [],
            result: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatModelsResult', schema: modelsResultSchema },
        },
        {
            ...
            parameters: [{
                    ...
                    wire: 'args',
                    source: 'json',
                    codec: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatStartArgs', schema: startArgsSchema },
                }],
            result: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatJobIdResult', schema: jobIdResultSchema },
        },
        {
            ...
            parameters: [{
                    ...
                    wire: 'args',
                    source: 'json',
                    codec: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatPollArgs', schema: pollArgsSchema },
                }],
            result: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatPollResult', schema: pollResultSchema },
        },
        {
            ...
            parameters: [{
                    ...
                    wire: 'args',
                    source: 'json',
                    codec: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatStopArgs', schema: stopArgsSchema },
                }],
            result: { mode: 'strict', typeSymbol: 'dsh-sidechat#SidechatStopResult', schema: stopResultSchema },
        },
    ],
};
