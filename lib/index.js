...
let SidechatService = (() => {
	...
	return class SidechatService extends _classSuper {
		static {
			...
			__esDecorate(this, null, _getContext_decorators, {
				kind: "method",
				name: "getContext",
				static: false,
				private: false,
				access: {
					has: (obj) => "getContext" in obj,
					get: (obj) => obj.getContext
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _models_decorators, {
				kind: "method",
				name: "models",
				static: false,
				private: false,
				access: {
					has: (obj) => "models" in obj,
					get: (obj) => obj.models
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
		...
		jobs = (__runInitializers(this, _instanceExtraInitializers), /* @__PURE__ */ new Map());
		seq = 0;
		constructor(ctx) {
			super(ctx, "sidechat");
			ctx.effect(() => () => {
...
//#endregion
export { SidechatService as default };
